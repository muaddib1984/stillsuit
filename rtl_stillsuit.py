...
class rtl_stillsuit(gr.top_block):
    ...
    def __init__(self, control_ip='127.0.0.1', control_port=8000, device_idx=0, rf_freq=750e6, rf_gain=20.0, samp_rate=2.56e6, zmq_out_ip='127.0.0.1', zmq_out_port=5000):
        ...
        self.soapy_rtlsdr_source_0 = soapy.source(dev, "fc32", 1, "driver=rtlsdr,rtl="+str(device_idx),
