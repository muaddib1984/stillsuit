...
class lime_oz39(gr.top_block):

    def __init__(self, control_ip='127.0.0.1', control_port=8000, rf_bw=20e6, rf_freq=750e6, rf_gain=50.0, samp_rate=20e6, zmq_out_ip='127.0.0.1', zmq_out_port=5000):
        gr.top_block.__init__(self, "Lime Oz39", catch_exceptions=True)
...
def main(top_block_cls=lime_oz39, options=None):
    if options is None:
