...
class lime_stillsuit(gr.top_block):

    def __init__(self, control_ip='127.0.0.1', control_port=8000, rf_bw=20e6, rf_freq=750e6, rf_gain=20.0, samp_rate=20e6, zmq_out_ip='127.0.0.1', zmq_out_port=5000):
        gr.top_block.__init__(self, "Lime Stillsuit", catch_exceptions=True)
        ...
        self.soapy_limesdr_source_0.set_bandwidth(0, rf_bw)
        ...
        # Connections
        ##################################################
        self.connect((self.soapy_limesdr_source_0, 0), (self.zeromq_pub_sink_0_0, 0))
    ...
    def set_rf_bw(self, rf_bw):
        self.rf_bw = rf_bw
        self.soapy_limesdr_source_0.set_bandwidth(0, self.rf_bw)
...
def main(top_block_cls=lime_stillsuit, options=None):
    if options is None:
